...
app.config["JWT_SECRET_KEY"] = os.getenv("JWT_SECRET", os.getenv("FLASK_SECRET", "dev-secret"))
app.config["JWT_ACCESS_TOKEN_EXPIRES"] = timedelta(days=1)  # 1 dia de validade
...
# Função helper para retornar JSON público do usuário
